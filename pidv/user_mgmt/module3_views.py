...
from user_mgmt.module3 import pie_chart_creator, general_tools, line_chart_creator, area_chart_creator, scatter_chart_creator
...
# this also handles area chart, scatter chart distinguished by graph_type
